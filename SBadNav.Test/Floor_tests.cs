...
namespace SBad.Nav.Test
{
	...
	public class Floor_tests
	{
		...
		public void FloorPlan_displays_costs()
		{
			...
			Debug.Write(display);
			display.Should().BeEquivalentTo("++_23" + Environment.NewLine + "456X+" + Environment.NewLine);
		}
		...
		public void FloorPlan_displays_paths()
		{
			...
			Debug.Write(display);
			display.Should().BeEquivalentTo("A+" + Environment.NewLine + "+B" + Environment.NewLine);
		}
		...
		public void FloorPlan_displays_agents()
		{
			...
			Debug.Write(display);
			display.Should().BeEquivalentTo("+@+" + Environment.NewLine);
		}
		[TestMethod]
		public void FloorPlan_detects_tiles()
		{
			...
			plan.GetFloorTile(20, 1).Cost.Value.Should().Be(1);

			plan.GetFloorTile(10, 2).Cost = 5;
			plan.GetFloorTile(10, 2).Cost.Value.Should().Be(5);
